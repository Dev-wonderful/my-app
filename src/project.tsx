    ...
    return ( 
        <section className={project.container}>
            ...
            <div className={project.section}>
                ...
                <div className={project.card}>
                    <div className={project.imagediv}><img src="https://avatars.githubusercontent.com/u/69244197?v=4?s=400" alt="Github Profile Picture" /></div>
                ...
                <div className={project.card}>
                    <div className={project.imagediv}><img src={image} alt="LinkedIn Profile Picture" /></div>
                    <h4>Wonderful Adeyemo - Frontend Web Developer - Freelance | LinkedIn</h4>
